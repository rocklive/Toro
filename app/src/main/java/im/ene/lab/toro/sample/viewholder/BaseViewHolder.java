 ...
 */
public abstract class BaseViewHolder extends RecyclerViewAdapter.ViewHolder {
  ...
  public static RecyclerViewAdapter.ViewHolder createViewHolder(ViewGroup parent, @Type int viewType) {
    final RecyclerViewAdapter.ViewHolder viewHolder;
    final View view;
